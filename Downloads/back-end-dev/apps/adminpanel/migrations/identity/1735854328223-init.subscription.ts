...
export class CreateIdentitySubscription1735854328223 implements MigrationInterface {
  transaction = false;
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    queryRunner.query(/*sql*/ `DROP SUBSCRIPTION IF EXISTS identity_subscription;`);
